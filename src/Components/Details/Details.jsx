    ...
    <div className="flex justify-center items-center max-w-96">
      <div className="details relative flex flex-col items-center justify-center bg-primaryCard border-t-2 md:border-2 border-primaryBorder rounded-md p-7 bg-white max-h-fit">
        <div className="mb-1 flex flex-col items-center relative">
          <img
            src={AimableImg}
            className="absolute -mt-14 w-20 border-4 border-primaryBorder rounded-lg bg-white"
          />
        ...
        <div className="mt-6">
          <Link
            className="border-2 rounded p-2 pr-5 pl-5 bg-primaryBg border-primaryBorder text-primaryText font-bold hover:bg-primaryBorder hover:text-white transition duration-200 ease-out"
